...
## ✨ Mejoras y Optimizaciones
 ...
 - Escalado automático de fuentes según DPI del sistema
 - Ajuste dinámico de componentes (menús, tablas, labels)
 - Mejoras visuales
 - Agregados idiomas, soporta: Inglés, Español, Francés, Alemán, Italiano, Portugués, Ruso
...
## ✨ Improvements and Optimizations
 ...
 - Automatic font scaling according to system DPI
 - Dynamic adjustment of components (menus, tables, labels)
 - Visual improvements
